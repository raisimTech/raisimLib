...
set_target_properties(raisim::raisimODE PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libraisimODE.so.1.1.5"
  IMPORTED_SONAME_RELEASE "libraisimODE.so.1.1.5"
  )

list(APPEND _cmake_import_check_targets raisim::raisimODE )
list(APPEND _cmake_import_check_files_for_raisim::raisimODE "${_IMPORT_PREFIX}/lib/libraisimODE.so.1.1.5" )
...
set_target_properties(raisim::raisim PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libraisim.so.1.1.5"
  IMPORTED_SONAME_RELEASE "libraisim.so.1.1.5"
  )

list(APPEND _cmake_import_check_targets raisim::raisim )
list(APPEND _cmake_import_check_files_for_raisim::raisim "${_IMPORT_PREFIX}/lib/libraisim.so.1.1.5" )
