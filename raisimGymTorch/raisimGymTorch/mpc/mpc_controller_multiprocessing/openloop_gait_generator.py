...
from raisimGymTorch.mpc.mpc_controller_multiprocessing import gait_generator
...
class OpenloopGaitGenerator(gait_generator.GaitGenerator):
  ...
  def reset(self, current_time):
    # The normalized phase within swing or stance duration.
    self._normalized_phase = np.zeros(4)
  ...
  def update(self, current_time, footContacts):
    contact_state = footContacts
