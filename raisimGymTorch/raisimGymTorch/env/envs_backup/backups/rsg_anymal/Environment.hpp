...
class ENVIRONMENT : public RaisimGymEnv {
 ...
 public:
  ...
  explicit ENVIRONMENT(const std::string& resourceDir, const Yaml::Node& cfg, bool visualizable) :
    ...
    // //make terrain!
    // std::vector<double> height_chosen;
    // std::vector<double> depth_chosen;
    // double delta = 0.01;    
    // gen_combined_terrain(height_chosen,depth_chosen,0.5,30,delta);
    // double xsize = (height_chosen.size()-1)*delta;
    // double ysize = 100;
    // size_t num_samples_x = height_chosen.size();
    // double center_x = xsize/2-1;
    // double center_y = 0;
    // std::vector<double> height_in = height_chosen;
    // height_in.insert(height_in.end(),height_chosen.begin(),height_chosen.end());
    // raisim::HeightMap* hm = world_->addHeightMap(num_samples_x, 2, xsize,ysize,center_x,center_y,height_in);
    ///////////////////////////////////////////////////////////////////////////////////////////
    /// get robot data
