...
# configuration
weight_path_arg = '/home/hyunyoungjung/MPC-RL/raisim/raisim_ws/raisimLib/raisimGymTorch/data/MPC_BC_baseline/2022-10-15-17-50-50/full_2200.pt'
...
env = VecEnv(MPC_BC_baseline.RaisimGymEnv(home_path + "/rsc", dump(cfg['environment'], Dumper=RoundTripDumper)), cfg['environment'])
...
# simulation
    ...
    # load sampler
    loaded_sampler = ppo_module.MultivariateGaussianDiagonalCovariance(rl_act_dim,env.num_envs,1.0,MPC_BC_baseline.NormalSampler(rl_act_dim),cfg['seed'])
