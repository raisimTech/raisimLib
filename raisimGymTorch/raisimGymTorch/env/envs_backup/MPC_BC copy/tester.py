...
import datetime
import numpy as np
from raisimGymTorch.mpc_BC import control
###################################################################
...
parser.add_argument('-w', '--weight', help='trained weight path', type=str, \
    default='/home/hyunyoungjung/MPC-RL/raisim/raisim_ws/raisimLib/raisimGymTorch/data/MPC_BC/2022-10-19-02-44-26/full_1400.pt')
...
################# my wandb #####################################
wandb.init(project="MPC_guide",group="1017",job_type="test",name="MPC_BC",notes="with BC loss"
...
# simulation
    ...
    # load sampler
    loaded_sampler = ppo_module.MultivariateGaussianDiagonalCovariance(rl_act_dim,env.num_envs,1.0,MPC_BC.NormalSampler(rl_act_dim),cfg['seed'])
