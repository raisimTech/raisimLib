...
wandb.init(project="MPC_guide",group="1017",job_type="train",name="with BC no random initialziation",
            notes="with BC loss in objective function no random initialziation"
