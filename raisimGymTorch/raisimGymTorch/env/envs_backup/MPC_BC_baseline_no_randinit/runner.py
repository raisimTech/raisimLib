...
from raisimGymTorch.env.bin.MPC_BC_baseline_no_randinit import RaisimGymEnv
from raisimGymTorch.env.bin.MPC_BC_baseline_no_randinit import NormalSampler
...
# task specification
task_name = "MPC_BC_baseline_no_randinit"
...
wandb.init(project="MPC_guide",group="1017",job_type="train",name="Baseline without random init",
            notes="Baseline without random initialization"
