...
for iter in range(maxIter):
    ...
    if iter%mpcDecimation == 0:
        ...
        my_helper.on_visualize(iseval=True,update=iter)
        ...
        for step in range(n_steps):
            ...
            #     perturbed_normed_obs = my_helper.change_normed_obs(raw_obs,perturbed_normed_obs) # get desired leg state for rl obs
            ...
            u_behavior = (alpha*u_mpc+(1-alpha)*u_rl_unnormalized).reshape(num_env,4,3)
