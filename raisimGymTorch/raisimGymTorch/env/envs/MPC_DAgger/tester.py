...
# configuration
weight_path_arg = '/home/hyunyoungjung/MPC-RL/raisim/raisim_ws/raisimLib/raisimGymTorch/data/MPC_DAgger/2022-11-01-03-15-54/full_50000.pt'
...
################# my wandb #####################################
wandb.init(project="MPC_guide",group="1129",job_type="test",name="MPC-DAgger",notes="MPC-DAgger"
...
# simulation
    ...
    # actual steps
    my_helper.on_visualize(update = iteration_number,istest=True)
    env.reset()
    ...
    simulation_step = total_steps*10
    for step in range(simulation_step):
        ...
        if dones or step == simulation_step - 1:
            # ############################################3 my comment ################################################
            print('----------------------------------------------------')
